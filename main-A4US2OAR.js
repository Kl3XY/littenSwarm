...
var ai = class e {
    ...
    static \u0275cmp = xo({
        ...
        dependencies: [ko],
        styles: [".container[_ngcontent-%COMP%]{width:100vw;height:100vh;background-color:#0f0;background-image:url(https://kl3xy.github.io/littenSwarm/assets/grassfield.png);background-repeat:repeat;background-size:1000px;position:relative;overflow:hidden;image-rendering:pixelated;image-rendering:-moz-crisp-edges;image-rendering:crisp-edges}.litten-container[_ngcontent-%COMP%]{position:absolute}.litten[_ngcontent-%COMP%]{position:absolute;width:150px;height:auto;image-rendering:pixelated;image-rendering:-moz-crisp-edges;image-rendering:crisp-edges;transition:left .1s linear;transform-origin:center center;z-index:2}.shadow[_ngcontent-%COMP%]{position:absolute;width:100px;height:auto;transition:left .1s linear;opacity:.5;mix-blend-mode:multiply;z-index:1}.shiny[_ngcontent-%COMP%]{filter:brightness(1.2) contrast(1.2)}.groudon[_ngcontent-%COMP%]{filter:drop-shadow(0 0 10px rgba(255,0,0,.5))}"]
    })
};
