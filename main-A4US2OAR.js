...
function wE(e, t) {
    if (e & 1 && (Ln(0, "div", 3), Vn(1, "img", 4, 0)(3, "img", 5), jn()), e & 2) {
        let n = t.$implicit;
        Fn("z-index", n.depth), bo(), Fn("top", n.top + n.verticalOffset, "px")("left", n.left, "px")("transform", "rotate(" + n.rotation + "deg) scaleX(" + (n.isFlipped ? -1 : 1) + ")")("width", n.isGroudon ? 300 : 150, "px"), ba("shiny", n.isShiny)("groudon", n.isGroudon), Ia("src", n.isGroudon ? n.isShiny ? "littenSwarm/assets/shinygroudon.gif" : "littenSwarm/assets/groudon.gif" : n.isShiny ? "littenSwarm/assets/ShinyLitten.png" : "littenSwarm/assets/Litten.png", yd), bo(2), Fn("top", n.top + 40, "px")("left", n.left + 20, "px")("width", n.isGroudon ? 200 : 100, "px")
    }
}
var ai = class e {
    littenImg;
    ...
    static \u0275cmp = xo({
        ...
        consts: [
            ...
            ["src", "littenSwarm/assets/littenShadow.png", "alt", "Shadow", 1, "shadow"]
        ],
